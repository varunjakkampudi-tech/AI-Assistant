...
const ITEMS: Item[] = [
  ...
  { icon: "time-outline", label: "Timeline", route: "/timeline", testID: "menu-timeline" },
  { icon: "journal-outline", label: "AI Journal", route: "/journal", testID: "menu-journal" },
  { icon: "fitness-outline", label: "Health", route: "/health", testID: "menu-health" },
  { icon: "git-network-outline", label: "Knowledge Graph", route: "/graph", testID: "menu-graph" },
  { icon: "people-outline", label: "Family Hub", route: "/family", testID: "menu-family" },
